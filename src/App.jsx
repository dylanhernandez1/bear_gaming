...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.error) {
      return (
        <div style={{ padding: 24, color: "white", background: "#0b0b0b", minHeight: "100vh" }}>
          <h2 style={{ color: "#ffb3b3" }}>Something failed to render</h2>
          <p style={{ color: "#b3b3b3" }}>
            An error occurred while loading the app. Check the browser console and the terminal where
            `npm run dev` is running for the full stack trace.
          </p>
          ...
          <p style={{ marginTop: 12 }}>
            <Link to="/" style={{ color: "#9d00ff" }}>Go to Home</Link>
          </p>
        </div>
      );
    }
...
function HomePlaceholder() {
  return (
    <div style={{ padding: 24 }}>
      ...
      <p style={{ color: "#b3b3b3" }}>
        If you see this, routing and basic rendering works. Try <Link to="/profile" style={{ color: "#9d00ff" }}>Profile</Link>.
      </p>
    </div>
  );
}
        ...
        <Route
          ...
          element={
            <div style={{ padding: 24 }}>
              ...
              <p style={{ color: "#b3b3b3" }}>
                Try <Link to="/" style={{ color: "#9d00ff" }}>Home</Link> or <Link to="/profile" style={{ color: "#9d00ff" }}>Profile</Link>.
              </p>
            </div>
          }
        />
